...
cover:
  ...
  caption: >-
    Codex Ravennas (Ravenna, Biblioteca Classense, MS 429), the *codex optimus* of
    Aristophanes and the only manuscript to transmit all eleven extant comedies, copied
    in Greek minuscule in the tenth–eleventh century (322 × 210 mm). The page reproduces
    the characteristic layout of the *Aristophanis codex cum argumentis et scholiis Anonymi*:
    the poet's verses run down the central column, framed by interlinear, marginal, and
    lower-margin scholia in a smaller, more cursive hand. The text here belongs to the
    *Acharnians*, where Dikaiopolis, having secured his private peace, stages a domestic
    Rural Dionysia — the ritual injunction εὐφημεῖτε, εὐφημεῖτε ("keep holy silence") is
    written out twice in the column, his daughter advances as basket-bearer (κανηφόρος),
    and the procession leads into the hymn to Phales, companion of Bacchus. The most
    substantial annotation, filling the foot of the page, preserves the aetiological
    scholion on the phallophoria: the cult statue of Dionysus brought from Eleutherai on
    the Boeotian–Attic border, the Athenians' initial rejection of the god, their
    punishment by an affliction of the male genitals (τὰ αἰδοῖα τῶν ἀνδρῶν), and the
    oracle-prescribed remedy of carrying phalloi in his honour — the standard ancient
    explanation for the rite Dikaiopolis parodies. Image source: Istituzione Biblioteca
    Classense, Ravenna (CC BY-NC-SA), https://www.cdc.classense.ra.it/s/Classense/item/4651
---
