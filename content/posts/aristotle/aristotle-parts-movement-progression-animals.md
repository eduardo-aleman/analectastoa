...
draft: false
cover:
  image: "/Vat.gr.1950.pt.2_0539_fa_0542r_m.jpg"
  alt: "Vatican City, Biblioteca Apostolica Vaticana, Vat. gr. 1950, pt. 2, fol. 542r — opening of De motu animalium, 14th century"
  caption: "Vatican City, Biblioteca Apostolica Vaticana, Vat. gr. 1950, pt. 2, fol. 542r — opening of De motu animalium ('Movement of Animals'), fols. 542r–545v. Vat. gr. 1950 is a large Byzantine manuscript miscellany of the fourteenth century whose contents, digitised across two parts, extend well beyond five hundred folios and encompass philosophical texts of several periods and genres. Fol. 542r opens the De motu animalium section directly, making it one of the three treatises gathered in the present Loeb volume. The manuscript is the same codex that preserves the only complete surviving text of Marcus Aurelius's Meditations (fols. 341r–392v) — a juxtaposition characteristic of the Byzantine scholarly tradition's practice of assembling major philosophical works into large working collections without regard for period, author, or school. The manuscript passed to the Biblioteca Apostolica Vaticana from the collection of the Ragusan scholar and Vatican librarian Stefano Gradi in 1683, where it has remained. A full digital facsimile is freely accessible through the Vatican's digital library at digi.vatlib.it. Biblioteca Apostolica Vaticana, Vatican City."
---
