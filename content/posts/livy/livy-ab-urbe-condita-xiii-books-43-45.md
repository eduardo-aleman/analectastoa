...
draft: false
cover:
  image: "/livy_fifth_decade_43.jpg"
  alt: "Medieval manuscript of Livy's Fifth Decade, Books 41–45"
  caption: "A medieval manuscript of Livy's Ab Urbe Condita, Fifth Decade. Books 43–45 — the last three surviving books of the Ab Urbe Condita — are the conclusion of what was originally a 142-book history of Rome; Books 46–142 are entirely lost and known only through epitomes. The manuscript tradition for the Fifth Decade is closely related to that of the Fourth."
---
...
Books 43–45 belong to the same medieval manuscript tradition as the Fourth Decade, described in the introduction to Volume IX. The Fifth Decade presents some additional textual difficulties: the final books appear to have been less frequently copied than the earlier portions, and the manuscript tradition for Book 45 in particular is thinner. Several passages, including portions of the triumph narrative, have required significant editorial reconstruction. The *Periochae* of the lost Books 46–142, which survive independently, begin immediately after the break in Book 45 and confirm that the surviving text does not correspond to the end of a natural narrative unit — the history was still very far from finished when the manuscript tradition stops.
