...
date: 2026-05-15
authors: ["Euripides"]
categories: ["Ancient Greek Satyr Play"]
tags:
  [
    "Euripides",
    "Satyr Play",
...
series: ["Euripides"]
summary: "Euripides' Cyclops — the only complete satyr play to survive from antiquity — a burlesque of Odysseus's escape from Polyphemus, performed by a chorus of satyrs and their father Silenus, and the sole intact witness to the fourth genre of the Athenian stage."
ShowToc: true
TocOpen: false
draft: false
cover:
  image: "/euripides-laurentianus-32-2.jpg"
  ...
  caption: "Laurentianus plut. 32.2 (Biblioteca Medicea Laurenziana, Florence), copied on paper around 1300–1325 and later corrected by Demetrius Triclinius, is the manuscript on which the text of the Cyclops depends. It preserves the group of Euripidean dramas known as the 'alphabetic plays' — works that survived outside the popular school selection because their titles happened to fall together in an alphabetic collection. Cyclops occupies the section under kappa (Kyklops); had that quire perished, as so many did, the only complete satyr play from the ancient world would be lost. The same library holds the Medicean codex of Aeschylus (Laurentianus 32.9)."
---
...
<iframe src="https://archive.org/embed/euripides0000euri_l8m6#page/514/mode/2up" width="100%" height="584" frameborder="0" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen></iframe>
